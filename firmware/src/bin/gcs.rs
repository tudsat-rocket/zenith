...
async fn join_uplink(
    ...
    mut ignition_button_rx: embassy_sync::watch::Receiver<'static, CriticalSectionRawMutex, bool, 2>,
    ...
    loop {
        ...
        let message = match input {
            Some(GroundInput::Eth(command) | GroundInput::Usb(command)) => match command {
            ...
            Some(GroundInput::IgnitionButton(true)) => {
                if pressurized {
